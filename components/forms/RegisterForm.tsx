        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              name="address"
              label="Dirección"
              placeholder="Av. 21 de Mayo 701, Los Ángeles"
            />
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              label="Historial médico familiar (si es relevante)"
              placeholder="La madre tuvo cáncer cerebral, el padre tiene hipertensión"
            />
