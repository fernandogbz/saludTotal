...
export const PatientFormValidation = z.object({
  ...
  primaryPhysician: z.string().min(2, "Selecciona al menos un doctor"),
  insuranceProvider: z
    .string()
  ...
  treatmentConsent: z
    ...
    .refine((value) => value === true, {
      message: "Debes dar tu consentimiento al tratamiento para continuar",
    }),
  disclosureConsent: z
    .boolean()
    .default(false)
    .refine((value) => value === true, {
      message: "Debes dar tu consentimiento a la divulgación para continuar",
    }),
  privacyConsent: z
    .boolean()
    .default(false)
    .refine((value) => value === true, {
      message: "Debes dar tu consentimiento de privacidad para continuar",
    }),
});
